...
public class NotaNegociacaoBovespa extends NotaNegociacao {
	...
	private List<ItemNotaNegociacao> itens = new ArrayList<>();
	
	
	public List<ItemNotaNegociacao> getItens() {
		return itens;
	}
	
	public void addItemNegociacao(ItemNotaNegociacao itemNotaNegociacao) {
		this.itens.add(itemNotaNegociacao);
	}
	...
	public String toCustomCSV() {
		StringBuilder objectContent = new StringBuilder();
		
		String prefix = "";
		for (ItemNotaNegociacao itemNotaNegociacao : itens) {
			
			String sufix = ";";
			objectContent.append(getDataPregao() + sufix);
			objectContent.append(getNrNotaNegociacao() + sufix);
			objectContent.append(itemNotaNegociacao.getTitulo() + sufix);
			objectContent.append(itemNotaNegociacao.getValorUnitario() + sufix);
			objectContent.append(itemNotaNegociacao.getQuantidade() + sufix);
			objectContent.append(itemNotaNegociacao.getCompraOuVenda() + sufix);
			objectContent.append(getCorretora());
